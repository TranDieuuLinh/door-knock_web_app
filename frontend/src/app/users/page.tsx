    ...
    <div className="flex h-full min-h-0 w-full bg-zinc-100 text-zinc-900">
      <aside className="flex w-56 shrink-0 flex-col bg-[#0d2574] px-5 py-6 text-white">
        ...
        <nav className="space-y-2 text-sm">
          <p className="rounded px-3 py-2 text-white/90">Runsheet</p>
          <p className="rounded px-3 py-2 text-white/90">Households</p>
          <p className="rounded bg-white/20 px-3 py-2 font-semibold">Volunteers</p>
          <p className="rounded px-3 py-2 text-white/90">Map</p>
          <p className="rounded px-3 py-2 text-white/90">Ranking</p>
          <p className="rounded px-3 py-2 text-white/90">Analyse</p>
        </nav>
